piece1 = Piece.create(title:"The Pre-arranged Flight", artist_name: "Jean-Honoré Fragonard", classification: "Paintings", century: "18th century", place: nil, image_url: "http://nrs.harvard.edu/urn-3:HUAM:VRS49028_dynmc", dimension: "59.1 x 50.2 cm (23 1/4 x 19 3/4 in.) framed: 82.2 x 73 x 10.3 cm (32 3/8 x 28 3/4 x 4 1/16 in.)", notes: nil )

piece2 = Piece.create(title:"Untitled (boy and German shepherd)", artist_name: "Bachrach Studios", classification:"Photographs" , century: "20th century", place: nil, image_url:"http://nrs.harvard.edu/urn-3:HUAM:INV154934_dynmc", dimension: "image: 24.2 x 19.2 cm (9 1/2 x 7 9/16 in.)", notes: nil )

piece3 = Piece.create(title:"Actor Ichikawa Monnosuke", artist_name: "Katsukawa Shunkô", classification:"Prints", century: nil, place: nil, image_url:"http://nrs.harvard.edu/urn-3:HUAM:CARP00963_dynmc", dimension: nil, notes: nil )

piece4 = Piece.create(title:"Kenny as Marilyn, Boston", artist_name: "Nan Goldin", classification:"Photographs", century: "20th century", place: nil, image_url:"http://nrs.harvard.edu/urn-3:huam:DDC113375_dynmc", dimension: "47.5 x 32.5 cm (18 11/16 x 12 13/16 in.) sheet: 50.8 x 40.6 cm (20 x 16 in.)", notes: nil )

piece5 = Piece.create(title:"Black Flag /Turrrrnnn Offff thhe Raaaadio", artist_name: "Raymond Pettibon", classification:"Prints", century: "20th century", place: nil, image_url:"http://nrs.harvard.edu/urn-3:HUAM:INV121690_dynmc", dimension: "sheet: 28 x 21.6 cm (11 x 8 1/2 in.)", notes: nil )
